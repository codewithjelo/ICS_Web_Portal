        ...
        <div class="modal-content" style="height:850px !important;">
            ...
            <div class="modal-body">
                            ...
                            <div class="row shadow mx-2 mb-5 rounded-3">
                                ...
                                <div class="col-md-12">
                                    <div class="row align-items-center pt-3">
                                        <div class="col-6" style="width: 100px; padding-left: 30px;">
                                            <img src="<?php echo htmlspecialchars($row['profile_picture']); ?>" alt="profilePic"
                                    ...
                                    <div class="row px-5 pt-3">
                                        ...
                                        <p class="lh-base" style="color: black;">
                ...
                <div class="fade" id="collapseExample">
                    <div class="card card-body position-absolute top-50 start-50 translate-middle"
                        style="width: 900px; height: 385px;">
                        <h2 class="text-center">EDIT ANNOUNCEMENT</h2>
                        <form action="../function/editAnnouncement.php" method="POST" enctype="multipart/form-data"
                            onsubmit="cleanTextBeforeSubmit()">
                            <input type="hidden" id="editAnnouncementId" name="announcement_id" value="">
                            <div class="mb-3">
                                <input type="text" class="form-control fw-bold" id="editAnnouncementTitle"
                                    name="announcement_title" value="">
                            </div>
                            <div class="mb-3">
                                <textarea class="form-control" id="editAnnouncementText" rows="4"
                                    name="announcement_text" style="height: 200px; white-space: pre-wrap;"></textarea>
                            </div>
                            <button type="button" class="btn btn-primary" data-bs-toggle="collapse"
                                data-bs-target="#collapseExample">Cancel</button>
