...
<div class="student-record-container row">
    <div class="student-record-dashboard p-3">
        <div class="student-record-scroll" style="max-height: 480px;"> 
            <h2 class="text-white d-flex align-items-center justify-content-center mb-2">STUDENT RECORDS</h2>
            
            <div class="table-responsive m-2" style="max-height: 390px; border-radius: 5px; overflow-y: scroll;">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr style="font-size: 12px;">
                                    ...
                                    <td>
                                        <?php if ($row['psa'] != NULL) { ?>
                                            <a class="btn btn-secondary d-flex flex-row"
                                                style="padding: 5px 0 0 8px; font-size: 12px; height: 30px; width: 95px; background-color: var(--maroon); color: var(--white);"
