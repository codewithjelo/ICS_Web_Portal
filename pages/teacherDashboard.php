                        ...
                        <div class="col-md-6">
                            <div class="info-section d-flex flex-row position-absolute bottom-0 start-0">
                                ...
                                $query = "SELECT CONCAT(t.last_name, ', ', t.first_name, ' ', LEFT(t.middle_name, 1), '.') AS full_name, 
                                            ...
                                            t.profile_picture AS profile_picture
                                        FROM teacher t
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <div class="user-info-admin d-flex flex-column justify-content-center">
                                            ...
                                            <p class="info-text text-start">
                                                ICS-TCH<?php echo htmlspecialchars($row['teacher_id']); ?></p>
            ...
            <div class="col-md-3">
                ...
                <div class="menu d-flex flex-column rounded-4 row-gap-4 p-4" style="height: 520px;">
                    <a type="button"
                        ...
                        data-bs-toggle="modal" data-bs-target="#inputGradesModal"><iconify-icon
                            class="menu-icon ph-icon" icon="material-symbols:list-alt-outline"></iconify-icon><span
                            style="margin: 0 0 0 10px;">Input Grades</span></a>
                    <a type="button"
                        class="text-break d-flex flex-row align-items-center btn menu-btn btn-primary rounded-2"
                        data-bs-toggle="modal" data-bs-target="#teacherMaterialsModal"><iconify-icon
                            class="menu-icon ph-icon" icon="ph:pen"></iconify-icon><span
                            style="margin: 0 0 0 10px;">School Materials</span></a>
                    <a type="button"
                        class="text-break d-flex flex-row align-items-center btn menu-btn btn-primary rounded-2"
                        data-bs-toggle="modal" data-bs-target="#eCertModal">
                        <iconify-icon class="menu-icon ph-icon" icon="ph:certificate"></iconify-icon>
                        <span style="margin: 0 0 0 10px;"> eCertificates</span>
                    </a>
                    <a type="button"
                        class="text-break d-flex flex-row align-items-center btn menu-btn btn-primary rounded-2"
                        data-bs-toggle="modal" data-bs-target="#turnOverModal"><iconify-icon class="menu-icon ph-icon"
                            icon="material-symbols:turn-right-rounded"></iconify-icon><span
                            style="margin: 0 0 0 10px;">Turnover Record</span></a>
                </div>
            </div>
